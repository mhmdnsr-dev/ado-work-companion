...
/**
 * Friendly professional signature footer — used on setup and app shells.
 */
export function AppFooter({ className }: { className?: string }) {
  return (
    <footer
      className={
        className ??
        'mt-auto border-t border-border/60 px-4 py-5 text-center text-sm text-muted-foreground'
      }
    >
      ...
      >
        <a
          ...
          className="inline-flex min-h-11 items-center gap-1.5 underline-offset-4 hover:text-foreground hover:underline"
        >
